 ...
 */
public class IngresoDeBoletines extends javax.swing.JInternalFrame {

    Connection con;
    ResultSet r;
    CallableStatement st;
    
    public IngresoDeBoletines() {
        initComponents();
    ...
    void Ocultar_Columnas(){
        JTBoletienesJardin.getColumnModel().getColumn(0).setMaxWidth(0);
        JTBoletienesJardin.getColumnModel().getColumn(0).setMaxWidth(0);
        JTBoletienesJardin.getColumnModel().getColumn(0).setPreferredWidth(0);
    }
    ...
    void mostrar (String buscar){
        try {
            ...
            fBoletines func=new fBoletines();
            modelo=func.mostrar(buscar);
            
            JTBoletienesJardin.setModel(modelo);
            Ocultar_Columnas();
            lbltotalregistros.setText("Total De Registros"+Integer.toString(func.totalregistrados));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        JBIBNuevo = new javax.swing.JButton();
        ...
        JBIBNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BotonesMenuVerdes/nuevo.png"))); // NOI18N
        JBIBNuevo.setBorder(null);
        JBIBNuevo.setBorderPainted(false);
        JBIBNuevo.setContentAreaFilled(false);
        JBIBNuevo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        JBIBNuevo.setFocusable(false);
        JBIBNuevo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JBIBNuevoActionPerformed(evt);
            }
        });
    ...
    private void JBBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBBGuardarActionPerformed
        ...
        else if (JTPLectoEscritura7.getText().isEmpty())
        {
                ...
                JTPLectoEscritura7.requestFocus();
                return;
        }
        ...
        else if (JTPAreasIntegradas8.getText().isEmpty())
        {
                ...
                JTPAreasIntegradas8.requestFocus();
                return;
        }
        ...
        if (JOptionPane.showConfirmDialog(null,"Desea Registrar El Boletin","Confirmar",1)==0){
           IngresoDeBoletines.DatosDeIngreso leer = new IngresoDeBoletines.DatosDeIngreso();
            ...
            Conexion_FormularioBoletines dts=new Conexion_FormularioBoletines();
            IngresoDeBoletines func =new IngresoDeBoletines();
            
            dts.setNombreDelAlumno(JTXBNombreDelAlumno.getText());
            dts.setGrado(JTXBGrado.getText());
            dts.setNumeroDelBoletin(JTXBNumeroDeBoletin.getText());
            dts.setFechaDeIngreso(JDCFecha.getDate());
            
            dts.setLogrosCognitiva(JTPCognitiva1.getText());
            int seleccionado=JCBBoletines1.getSelectedIndex();
            dts.setLogrosCognitiva(JCBBoletines1.getItemAt(seleccionado));
            
            
            dts.setLogrosComunicativa(JTPComunicativa2.getText());
            seleccionado=JCBBoletines2.getSelectedIndex();
            dts.setLogrosComunicativa((String)JCBBoletines2.getItemAt(seleccionado));
            
            
            dts.setLogrosActitudesYValores(JTPActitudes3.getText());
            seleccionado=JCBBoletines3.getSelectedIndex();
            dts.setLogrosComunicativa((String)JCBBoletines3.getItemAt(seleccionado));
            
            
            dts.setLogrosEstetica(JTPEstetica4.getText());
            seleccionado=JCBBoletines4.getSelectedIndex();
            dts.setLogrosEstetica((String)JCBBoletines4.getItemAt(seleccionado));
            
            
            dts.setLogrosCorporal(JTPCorporal5.getText());
            seleccionado=JCBBoletines5.getSelectedIndex();
            dts.setLogrosCorporal((String)JCBBoletines5.getItemAt(seleccionado));
            
            
            dts.setLogrosPreMatematicas(JTPMatematicas6.getText());
            seleccionado=JCBBoletines6.getSelectedIndex();
            dts.setLogrosPreMatematicas((String)JCBBoletines6.getItemAt(seleccionado));
            
            
            dts.setLogrosLectoEscritura(JTPLectoEscritura7.getText());
            seleccionado=JCBBoletines7.getSelectedIndex();
            dts.setLogrosLectoEscritura((String)JCBBoletines7.getItemAt(seleccionado));
            
            
            dts.setLogrosAreasIntegradas(JTPAreasIntegradas8.getText());
            seleccionado=JCBBoletines8.getSelectedIndex();
            dts.setLogrosAreasIntegradas((String)JCBBoletines8.getItemAt(seleccionado));
            
            
            dts.setLogrosIngles(JTPIngles9.getText());
            seleccionado=JCBBoletines9.getSelectedIndex();
            dts.setLogrosIngles((String)JCBBoletines9.getItemAt(seleccionado));
    ...
    private void JBIBNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBIBNuevoActionPerformed
        // TODO add your handling code here:
        habilitar();
        JBIBNuevo.setText("Guardar");
        accion="guardar";
        
    }//GEN-LAST:event_JBIBNuevoActionPerformed
    ...
    private javax.swing.JButton JBIBNuevo;
